...
abstract mixin class EventListener {
  ...
  /// to notify all subscribers that an event has occured or some state has changed.
  void callListeners();
...
void main() {
  ...
  void callback1(Counter counter) => print('listener1 called as value changes: ${counter.value}');

  void callback2(Counter counter) => print('listener2 called as value changes: ${counter.value * counter.value}');
...
//          such as a FutureBuilder or StreamBuilder in the Flutter SDK of Future.then calls
