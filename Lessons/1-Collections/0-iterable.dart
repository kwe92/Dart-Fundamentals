...
void main() {
  ...
  //   - static type is an Iterable type (tooling can know what the class can and can't do | what methods and properties it has)

  // homogenous Iterable of Strings (Strings themselves are a type of iterable but do not implement Iterable directly; as each character can be accessed by index using bracket notation, loops, and control flow statements)
  ...
  //    - modifiable / mutable, may return a e pointer in memory if modified
...
//   - if a List or Set literals type annotation (static type) is an Iterable it can't be indexed using brackets
