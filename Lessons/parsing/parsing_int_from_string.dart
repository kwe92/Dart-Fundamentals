// TODO: Parse an integer from Payments Terms and return todays date plus that integer as days
...
DateTime _paymentDue(String paymentTerm) {
  ...
  final newDate =
      new DateTime(date.year, date.month, date.day + parseInt(paymentTerm));
