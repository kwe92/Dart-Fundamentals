...
class HttpClient {
  ...
  static final instance = http.Client();
}
...
mixin HttpServiceMixin {
  ...
  Future<http.Response> get(
    ...
    try {
      final http.Response response = await HttpClient.instance.get(
  ...
  Future<http.Response> post(
    ...
    try {
      final http.Response response = await HttpClient.instance.post(
        Uri.parse(tempHost ?? host + endpoint),
        headers: headers..addAll(extraHeaders ?? {}),
        body: body,
      );
  ...
  Future<http.Response> put(
    ...
    try {
      final http.Response response = await HttpClient.instance.put(
        Uri.parse(tempHost ?? host + endpoint),
        body: body,
        headers: headers..addAll(extraHeaders ?? {}),
      );
