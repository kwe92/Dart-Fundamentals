...
void main() {
  ...
  final groupedData =
      groupBy<Transaction, String>(transactions, (transaction) => timeService.getStringFromDate(transaction.transactionDate!));

  // final groupedData = groupBy([for (var transaction in transactions) transaction.toJson()],
  //     (Map obj) => "${DateTime.parse(obj['transaction_date'].toString()).month}_${DateTime.parse(obj['transaction_date'].toString()).day}");
