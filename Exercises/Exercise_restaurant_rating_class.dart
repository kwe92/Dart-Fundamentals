...
void main() {
  final Restaurant r1 = Restaurant(name: 'Titos', cuisine: 'Tex Mex', ratings: [4.6, 4.5, 4.9, 4.1]);
...
class Restaurant {
  ...
  double? avgRatings() {
    ...
    return round(this.ratings.reduce((value, element) => value + element) / this.ratings.length, 2);
  }
}
